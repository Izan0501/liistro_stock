    ...
    <div className="max-w-7xl mx-auto space-y-6 animate-in fade-in transition-opacity duration-300 p-4 md:p-8 pb-24 md:pb-8">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">Revisar ventas y entregas anteriores.</p>
        </div>
      </div>
      ...
      <div className="glass-card p-4 flex flex-col md:flex-row gap-4">
        <div className="relative flex-1 max-w-md">
          <label htmlFor="search-deliveries" className="sr-only">Buscar por nombre</label>
